...
Зависимость $\psi_\varepsilon$ от $\psi_\mathrm{II}$ и $z_\text{В}$ представлена на рисунке \ref{psi_eps_1}.

\begin{figure}[H]
\centering
\includegraphics[width=0.7\textheight]{images/psi_eps_1.png}
\caption{Зависимость $\psi_\varepsilon$ от $\psi_\mathrm{II}$ и $z_\text{В}$}
\label{psi_eps_1}
\end{figure}

Зависимость $\psi_\varepsilon$ от $\psi_\mathrm{I}$, $\alpha_\text{п}$, $M$ и $\varphi_\alpha$ представлена на рисунке \ref{psi_eps_2}.
...
Зависимость $\varepsilon^\alpha_\text{ср}$ от $\psi_\mathrm{I}$, $\alpha_\text{п}$, $M$ и $\varphi_\alpha$ представлена на рисунке \ref{eps_alpha_2}.

\begin{figure}[H]
\centering
\includegraphics[width=0.77\textheight]{images/eps_alpha_2.png}
\caption{Зависимость $\varepsilon^\alpha_\text{ср}$ от $\psi_\mathrm{I}$, $\alpha_\text{п}$, $M$ и $\varphi_\alpha$}
\label{eps_alpha_2}
\end{figure}
...
\caption{Зависимость $k_{q \text{из.рл}}$ от $M$}
\label{k_q}
\end{figure}
...
\caption{Зависимость $k_{q \text{нос}}$ от $M$}
\label{k_q_nos}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textheight]{images/с_alpha_y.png}
\caption{Зависимость $c^\alpha_y$ от $M$ и $\alpha$}
\label{с_alpha_y}
\end{figure}
