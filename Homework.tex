...
Взаимное влияние несущей поверхности с фюзеляжем определяется коэффициентом интерференции $K_{\alpha \alpha}$
...
\[
(K_{\alpha \alpha})_{\text{теор}} = (1 + \bar{0.6952})^2 = 2.873
\]

Таким образом, влияние интерференции представлено на графике \ref{C_y_iz.kr_Intrf}.

\begin{figure}[H]
\centering
\includegraphics[width=0.7\textheight]{images/C_y_iz.kr_Intrf.png}
\caption{График зависимости $c_{y\text{из.кр}}$ с учетом интерференции}
\label{C_y_iz.kr_Intrf}
\end{figure}
